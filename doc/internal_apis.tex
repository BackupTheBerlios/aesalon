...
Two more functions that should be covered off:

\documentFunction{void}{AC\_constructor}{}{Called when the module is initializing.}
\documentFunction{void}{AC\_destructor}{}{Called just before the program exits.}

These two functions should be implemented in each collector module; even if they are only stubs.
