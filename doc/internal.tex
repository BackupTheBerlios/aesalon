...
\documentFunction{uint16\_t}{AC\_registerModuleInternal}{const char *name}{Internal function, registers a module and returns
its ID.}
...
\documentMacro{AC\_registerModule}{const char *name}{Calls \emph{AC\_registerModuleInternal()} and \emph{AC\_setModuleID()},
in essence registering a module for use.}
